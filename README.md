...
とはいえ、若い人が多いエンジニアの職場では、40歳に近いと厳しいかもしれません。
そういう方は、いきなりフリーランスを目指す、またはIT部門に異動することも検討しなくてはならないかもしれません。
...
- 師範代レベルに達した場合は、道場の後輩指導を手伝っていただき、対価を支払います。
- 生徒が個人で仕事を受ける際の相談にものります。契約や見積もりの仕方などなど。仕事の斡旋の予定は現在ありません。
...
![spectrum](./images/spectrum_chat.png)
...
まずは、簡単な[インタビュー](https://bcts369dojo.github.io/basic_questions)をさせていただきます。
...
- 月謝9,980円（前払い制。入門時に初回の費用をお支払いいただきます）
- １年間一括活払いの場合は 95,808円（20%割引）です。
- 半年一括払いの場合は、53,892円（10%割引）です。
...
- 暗号資産（仮想通貨）でのお支払
  ...
  - **道場としてはこちらをお薦めします** どのみち課題で暗号資産を使います。
- 銀行振込でのお支払
  - Twitterまたはメールでお伝えします。

## 免罪事項
- 努力しているにも関わらず、完全に不向きと判断した場合は6ヶ月以内に通達します。その場合、支払い済みの残金があれば返金します。
