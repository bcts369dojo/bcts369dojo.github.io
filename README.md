...
一般的なプログラミングスクールとは違い、実際にスタートアップのような小規模企業に就職後、すぐに実戦投入されたという想定の元で進めていきます。

また、本道場ではサーバーサイド技術の習得をメインとし、言語はGo言語をメインで使用します。 課題の内容によっては、JavaScriptやPythonも一部使用します。
